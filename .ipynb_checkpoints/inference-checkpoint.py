...
from gfpgan import init_gfpgan
...
def get_face_from_cache(video_path: str, frequency: str):
    ...
    if not face_list or not all_landmarks_5 or len(face_list) != len(all_landmarks_5):
...
if __name__ == '__main__':
    a = time.time()
    print(main("北影推理视频和音频/北影音频1.wav", "beiying3.mp4", "pt28.pth"))
    b = time.time()
    print("time", b - a)
